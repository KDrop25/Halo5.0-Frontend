      ...
      <div class="profile-card-main profile-navigation-card">
        <div class = "profile-navigation-cards-group-upper">
            ...
            <div class="profile-cards profile-navigation-cards-hero">
              ...
              <h1 class="profile-navigation-hero-text">PROFILE</h1>
            </div>
          ...
          <div class="profile-vertical-cards profile-vertical-cards-upper profile-navigation-card-group-mid">
            ...
            <div class="profile-cards profile-navigation-cards-menu">
              ...
              <h1 class="profile-navigation-hero-menu-text">Home</h1>
            </div>

            <div class="profile-cards profile-navigation-cards-menu">
              <img class="profile-form__icon-menu" src={homelogo} alt=''/>
              <h1 class="profile-navigation-hero-menu-text">Events</h1>
            </div>

            <div class="profile-cards profile-navigation-cards-menu">
              <img class="profile-form__icon-menu" src={homelogo} alt=''/>
              <h1 class="profile-navigation-hero-menu-text">Participants</h1>
            </div>

            <div class="profile-cards profile-navigation-cards-menu">
              <img class="profile-form__icon-menu" src={homelogo} alt=''/>
              <h1 class="profile-navigation-hero-menu-text">Payments</h1>
            </div>
        ...
        <div class = "profile-navigation-cards-group-lower">
          <div class="profile-cards profile-navigation-cards-profile">
            <img class="profile-form__icon-profile" src={pfpfile? URL.createObjectURL(pfpfile) : userlogo} alt=''/>
            <h1 class="profile-navigation-hero-profile-text">{auth.Username}</h1>
          </div>
        </div>
      </div>
        ...
        <div class="profile-card-main profile-card-group">
          <div class="profile-horizontal-cards profile-card-group-top">
            ...
            <div class="profile-cards profile-cards-top">
              ...
              <img class="profile-form__icon-top" alt ='userprofilepic' src={pfpfile? URL.createObjectURL(pfpfile) : userlogo} onClick={handleImageClick}/>
              
              <h1 class="profile-main-username-text">{auth.Username}</h1>
            </div>
          ...
          <div class="profile-horizontal-cards profile-card-group-bottom">
            <div class="profile-cards profile-cards-bottom">
                ...
                <form class="profile-form" onSubmit={handleEdit}>

                
                
                  {/* USERNAME AND EMAIL */}
                  <div>
                    <input class="profile-form__input" id='profile-username' ref={userRef} type="text" placeholder="Username" value={auth.Username} readOnly={isFieldsLocked} required/>
                    <input class="profile-form__input" id='first_name' type="text" placeholder="Email" value={auth.email} readOnly={isFieldsLocked} required/>
                  </div>
                  {/* FIRSTNAME AND LASTNAME */}
                  <div>
                    <input class="profile-form__input" id='firstname' onChange={(e) => setFirstname(e.target.value)} value={isFieldsLocked ? auth.Firstname : firstname} type="text" placeholder="Firstname" readOnly={isFieldsLocked} required/>
                    <input class="profile-form__input" id='lastname' onChange={(e) => setLastname(e.target.value)} value={isFieldsLocked ? auth.Lastname : lastname} type="text" placeholder="Lastname" readOnly={isFieldsLocked} required/>
                  </div>
                  ...
                  <div className='profile-horizontal-fields'>
                    ...
                    <input class="profile-form__input" id='mobilenumber' onChange={handleMobileNumberChange} value={isFieldsLocked ? auth.MobileNumber : mobileNumber} type="text" placeholder="Mobile No." readOnly={isFieldsLocked} required />
                    <input class="profile-form__input" id='whatsmobileNumber' onChange={(e) => setWhatsMobileNumber(e.target.value)} value={isFieldsLocked ? auth.WhatsMobileNumber :whatsmobileNumber} type="text" placeholder="Whatsapp No." readOnly={isFieldsLocked} required/>
                    <input class={!isFieldsLocked? "profile-form__checkbox":"hidden-checkbox"} type="checkbox" placeholder="Whatssap No." checked={isSameAsMobile} readOnly={isFieldsLocked} onChange={handleCheckboxChange}/>
                    <p class={!isFieldsLocked?"profile-form__checkbox-text" : "hidden-checkbox-text"}>Is Whatssap No.<br/> Same as Mobile No.?</p>
                  </div>
                  ...
                  <div className='profile-horizontal-fields alternate-number'>
                    ...
                    <input class="profile-form__input" id='altmobilenumber' onChange={(e) => setAltMobileNumber(e.target.value)} value={isFieldsLocked ? auth.AltMobileNumber:altmobileNumber} type="text" placeholder="Alternate No." readOnly={isFieldsLocked}  />
                    <input class="profile-form__input" id='schoolname' onChange={(e) => setSchoolname(e.target.value)} value={isFieldsLocked ? auth.SchoolName :schoolname} type="text" placeholder="School/Institution Name" readOnly={isFieldsLocked} required/>
                  </div>
                  ...
                  <button class="profile-form__button profile-button profile-save"  disabled = {isFieldsLocked} >SAVE</button>
                  </div>
                </form>
            </div>
